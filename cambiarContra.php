...
<div class="content">
  <div class="container">
      ...
      <div>
          <form>
              email:<input type="email" name="emailCambio" required />
              <br>
              Contraseña:<input type="text" name="contra1" />
              <br>
              Confirmar Contraseña:<input type="text" name="contra2" />
              <br>
              <input type="submit" name="cambioContra" />
          </form>
      </div>
